...
# similarity search
document= ["Protein LLMs are essentially deep learning models, often based on transformer architectures, that are trained on massive datasets of protein sequences (like those found in databases like UniProt)",
